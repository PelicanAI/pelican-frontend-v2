...
const DEFAULT_OPTIONS: Required<RetryOptions> = {
  ...
  baseDelay: 1000,
  maxDelay: 10000,
  timeout: 2700000, // 45 minute default timeout
...
export async function fetchWithRetry(
  ...
  const extendedTimeout = isDirectBackendCall ? undefined : (isPelicanResponse ? 2700000 : undefined)
...
export async function streamWithRetry(
  ...
  return fetchWithRetry(url, {
    ...
    retryOptions: {
      maxRetries: 2,
      baseDelay: 500,
      timeout: 2700000, // 45 minutes for streaming requests
