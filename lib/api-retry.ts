...
const DEFAULT_OPTIONS: Required<RetryOptions> = {
  ...
  baseDelay: 1000,
  maxDelay: 10000,
  timeout: 1200000, // 20 minute default timeout
...
export async function fetchWithRetry(
  ...
  const extendedTimeout = isDirectBackendCall ? undefined : (isPelicanResponse ? 1200000 : undefined)
...
export async function streamWithRetry(
  ...
  return fetchWithRetry(url, {
    ...
    retryOptions: {
      maxRetries: 2,
      baseDelay: 500,
      timeout: 1200000, // 20 minutes for streaming requests
