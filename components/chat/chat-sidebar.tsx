    ...
    <div className="w-64 border-r bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 flex flex-col">
      ...
      <div className="p-3 border-b">
        <div className="flex items-center justify-between mb-3">
          ...
          <Button variant="ghost" size="icon" onClick={onToggleCollapse} className="w-6 h-6">
            <X className="h-3 w-3" />
          </Button>
        </div>

        <Button onClick={onNewChat} className="w-full justify-start gap-2 h-9 bg-transparent" variant="outline">
          <Plus className="h-4 w-4" />
          New chat
        </Button>
      </div>
