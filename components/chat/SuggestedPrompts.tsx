      ...
      <div className="grid grid-cols-2 md:grid-cols-3 gap-2 sm:gap-3 pb-2">
        {SUGGESTED_PROMPTS.map((prompt, index) => (
          <motion.button
            ...
            whileHover={{ y: -2 }}
            className="p-3 sm:p-4 rounded-xl border border-border bg-muted/30 hover:bg-muted hover:border-primary/30 hover:shadow-md transition-[background-color,border-color,box-shadow] duration-150 ease-out text-left cursor-pointer group"
          >
